...
export class DynamicInputMaskDirective implements ControlValueAccessor, OnChanges {
  ...
  ngOnChanges(): void {
    ...
    const replaceValue: IReplaceValueData = this.replaceText(this.maskOptions.event ? this.maskOptions.event : this.erf.nativeElement);
  ...
  onInput(e: Event): void{
    if(this.maskOptions?.dynamic) return;
